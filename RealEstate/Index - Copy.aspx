...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        <%--function minRentSelect(optionNo) {
            alert(document.getElementById('<%=ddlMaxRent.ClientID%>').options[2].value);              
            document.getElementById('<%=ddlMaxRent.ClientID%>')[2].style.display ="none";
            for (var i = optionNo; i = 1; i--) {
                alert(i);
                document.getElementById('<%=ddlMaxRent.ClientID%>').options[i].display = "none";
            }           
        }--%> 
    ...
    $(".chosen-choices").focusout(function(){
        var location = [];
        $.each($("#ContentPlaceHolder1_ddlLocation option:selected"), function(){            
            location.push($(this).text());
        });

        $('#<%=lblLocations.ClientID%>').val(location.join(","));
    });
});
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="row">
                        <div class="col-6 col-lg-3 col-md-3 col-sm-6">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlStatus" runat="server" class="selectpicker search-fields" onchange="ddlStatusChange(this.options);">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlLocation" runat="server" class="selectpicker search-fields chosen-select" data-placeholder="Choose a Location..." multiple="multiple" tabindex="2"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div id="Rent" class="form-group">
                                ...
                                <table>
                                    <tr>
                                        <td width="50%">
                                            <asp:DropDownList ID="ddlMinRent" runat="server" class="selectpicker search-fields" Width="80px" onchange="minRentSelect(this.selectedIndex);">
    ...
    <div class="featured-properties content-area-19">
        <div class="container">
            <asp:TextBox ID="lblLocations" runat="server" Font-Size="1px" ForeColor="#fafafa" BorderStyle="None"></asp:TextBox>
    ...
    <div class="intro-section">
        <div class="container">
            <div class="row">
                ...
                <div id="mr-auto1" class="col-lg-3 col-md-3 col-sm-12">
