<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="SoldOutProperties.aspx.cs" Inherits="RealEstate.cpanel.SoldOutProperties" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Sold Out Properties</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12 main">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Sold Out Properties</h5>
                    </div>
                    <div class="ibox-content">
                        <input type="text" class="form-control input-sm m-b-xs" id="filter" placeholder="Search in table">

                        <asp:Repeater ID="rptrSoldOutProperty" runat="server">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                                <tr class="gradeX">
                                    ...
                                    <td class="center" style="text-align:center">
                                        <asp:Label ID="Label2" runat="server" Text='<%#Eval("area").ToString() == "" ? "-" : Eval("area").ToString() + " sq.ft" %>'></asp:Label>
                                    </td>
                                    <td class="center" style="text-align:center">
                                        <asp:Label ID="Label3" runat="server" Text='<%#Eval("soldPrice")%>'></asp:Label>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
