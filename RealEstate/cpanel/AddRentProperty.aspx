<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="AddRentProperty.aspx.cs" Inherits="RealEstate.cpanel.AddRentProperty" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>     
        function validateForm() {
            ...
            if (document.getElementById('<%=txtDeposit.ClientID%>').value == "") {
                document.getElementById("lblDeposit").style.display = "block";
                document.getElementById('<%=txtDeposit.ClientID%>').focus();
                return false;
            }
            if (document.getElementById('<%=txtMaintenance.ClientID%>').value == "") {
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="ManageRentProperty.aspx">Property for Rent</a>
                </li>
                <li class="active">
...
<%--                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <table>
                                        <tr>
                                            <td><input id="txtFloor" runat="server" class="form-control" type="number" min="0" max="50" style="width:60px" title="floor of property" onclick="hideFloorlbl()"/></td>
                                            <td style="font-size:28px;font-weight:100">/</td>
                                            <td><input id="txtTotalFloor" runat="server" class="form-control" type="number" min="0" max="50" style="width:60px" title="Total floor of building" onclick="hideTotalFloorlbl()"/></td>
                                        </tr>
                                    </table>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Preferred Tenants</label>
                                <div class="col-sm-9">
                                    <asp:DropDownList ID="ddlTenants" runat="server" CssClass="form-control" onclick="hideTenantslbl()">
                                        ...
                                        <asp:ListItem Text="Bachelor Girls Only" Value="4"></asp:ListItem>
                                        <asp:ListItem Text="Company" Value="5"></asp:ListItem>
                                        <asp:ListItem Text="Does not matter" Value="6"></asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Rent Amount</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Maintenance Amount</label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtMaintenance" runat="server" class="form-control" onkeypress='javascript:return isDecimalNumber(event,this);'  onclick="hideMaintenancelbl()"></asp:TextBox>                                    
                            ...
                            <div class="form-group" id="brokerageMonth">
                                <label class="col-md-3 control-label">Brokerage</label>
                                <div class="col-sm-9">
                                    <asp:DropDownList ID="ddlBrokerageMonth" runat="server" CssClass="form-control" onchange="ddlBrokerageMonth(this.value);">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" style="text-align:left">Property Photos</label>                          
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div id="drop" style="margin-top:5px">
                                        <input type="button" value="Drop Pin" onclick="dropPin()" /> &nbsp Drop a marker on the center of the map<br />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
