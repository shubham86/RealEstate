...
{
    public partial class SoldOutProperties : System.Web.UI.Page
    {
        ...
        public void fillRepeater()
        {
            ...
            try
            {
                ...
                objDAL.QueryName = "proc_RealEstate_SoldPropertyCusrtomer_fetchInRepeater";

                DT = objDAL.FetchDatainDT();
                if (DT.Rows.Count > 0)
                {
                    rptrSoldOutProperty.DataSource = DT;
                    rptrSoldOutProperty.DataBind();
                }
                else
                {
                    rptrSoldOutProperty.DataSource = null;
                    rptrSoldOutProperty.DataBind();
                }
            }
            catch (Exception ex)
