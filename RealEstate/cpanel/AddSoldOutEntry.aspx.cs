...
{
    public partial class AddSoldOutEntry : System.Web.UI.Page
    {
        ...
        private bool insertSoldOutEntry(int ID)
        {
            ...
            try
            {
                ...
                objBEL.soldPrice = Convert.ToDecimal(txtPrice.Text);
                ...
                if (objBALL.addSoldOutEntry(objBEL))
                {
                    return true;
                }
                else
        ...
        protected void btnSkip_Click(object sender, System.EventArgs e)
        {
            ...
            {
                deletePropertyPhotos(Convert.ToInt32(Request.QueryString["ID"]));
                Response.Redirect("ManageSaleProperty.aspx?action=rentOut");
                return;
            }
            else
            {
