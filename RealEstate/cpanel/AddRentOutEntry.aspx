<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="AddRentOutEntry.aspx.cs" Inherits="RealEstate.cpanel.AddRentOutEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function validateForm() {
            ...
            if (document.getElementById('<%=txtAgrimentMonth.ClientID%>').value == "") {
                document.getElementById("lblAgrimentMonth").style.display = "block";
                document.getElementById('<%=txtAgrimentMonth.ClientID%>').focus();
                return false;
            }                       
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal" style="margin-top:10px">                            
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Agriment Month</label>
                                <div class="col-sm-9">
                                    <input id="txtAgrimentMonth" runat="server" class="form-control" type="number" min="1" max="36"  onclick="hideAgrimentMonthlbl()" onkeypress='javascript:return isNumberKey(event,this);'/>                                    
                                    <label id="lblAgrimentMonth" class="error">Please select possession date</label>
                                </div>
                            </div>                            
                            <div class="form-group">
