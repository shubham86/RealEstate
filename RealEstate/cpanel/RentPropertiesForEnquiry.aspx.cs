...
{
    public partial class RentPropertiesForEnquiry : System.Web.UI.Page
    {
        ...
        public void fetchEnquiry()
        {
            ...
            try
            {
                ...
                if (DT.Rows.Count > 0)
                {
                    ...
                    lblBed.Text = DT.Rows[0]["bedrooms"].ToString();
                    lblBath.Text = DT.Rows[0]["bathrooms"].ToString();
        ...
        public void fillRepeater()
        {
            ...
            try
            {
                objDAL.SQLConnectionString = ConfigurationManager.ConnectionStrings["CONST_RealEstate_DBCONN"].ToString();
                objDAL.QueryType = "procedure";
                objDAL.QueryName = "proc_RealEstate_RentProperties_fetchByEnquiry";
                ...
                objDAL.SetParameters("@rentBudget", "decimal", (Convert.ToDecimal(lblBudget.Text)+Convert.ToDecimal(2000)), 13);
        ...
        protected void rptrProperty_RowCommand(object sender, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("RentPropertyDetail.aspx?ID=" + e.CommandArgument + "&EnqID=" + Request.QueryString["ID"].ToString(), false);
                return;
            }

            if (e.CommandName == "sold")
            {
                Response.Redirect("AddRentOutEntry.aspx?ID=" + e.CommandArgument + "&EnqID=" + Request.QueryString["ID"].ToString(), false);
                return;
            }
        }
        ...
        {
            Response.Redirect("ManageRentEnquiry.aspx");
        }
    }
}