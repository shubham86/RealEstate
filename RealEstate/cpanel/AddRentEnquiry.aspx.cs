...
{
    public partial class AddRentEnquiry : System.Web.UI.Page
    {
        ...
        public void fetchEnquiry()
        {
            ...
            try
            {
                ...
                if (DT.Rows.Count > 0)
                {
                    ...
                    txtRent.Text = DT.Rows[0]["rentBudget"].ToString();
                }
                else
                {
                    pnlAlert.Attributes.Add("class", "alert alert-danger");
        ...
        protected void btnSave_Click(object sender, System.EventArgs e)
        {
            if (Request.QueryString["ID"] != null)
            {
                ...
                {
                    Response.Redirect("ManageRentEnquiry.aspx?action=update");
                    return;
                }
                else
                {
            ...
            else
            {
                ...
                {
                    ClearForm();
                    Response.Redirect("ManageRentEnquiry.aspx?action=insert");
                    return;
                }
                else
                {
        ...
        private bool insertEnquiry()
        {
            ...
            try
            {
                ...
                objBEL.rentBudget = Convert.ToDecimal(txtRent.Text);
                objBEL.priceBudget = null;
