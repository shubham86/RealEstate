...
{
    public partial class ManageSaleProperty : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else if (Request.QueryString["action"] == "soldOut")
                {
                    pnlAlert.Attributes.Add("class", "alert alert-success");
                    pnlAlert.Visible = true;
                    lblalert.Text = "Record register as sold Out successfully !!!";
                }
                fillRepeater();
            }
        }
        ...
        public void fillRepeater()
        {
            ...
            try
            {
                ...
                objDAL.QueryName = "proc_RealEstate_SaleProperties_fetchInRepeater";
        ...
        protected void rptrProperty_RowCommand(object sender, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AddSaleProperty.aspx?ID=" + e.CommandArgument, false);
                return;
            }

            if (e.CommandName == "sold")
            {
                Response.Redirect("AddSoldOutEntry.aspx?ID=" + e.CommandArgument, false);
                return;
            }
        }
        ...
        {
            Response.Redirect("AddSaleProperty.aspx", false);
            return;
        }
    }
}