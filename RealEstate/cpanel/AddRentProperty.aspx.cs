...
{
    public partial class AddRentProperty : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (DS.Tables.Count > 0)
                {
                    if (DS.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            ddlSource.Items.FindByValue("0").Selected = true;
                        }
                        ...
                        if (DS.Tables[0].Rows[0]["preferredTenants"].ToString() != "Null")
                        {
                            ddlTenants.Items.FindByText(DS.Tables[0].Rows[0]["preferredTenants"].ToString()).Selected = true;
                        }
                        ...
                        txtRent.Text= DS.Tables[0].Rows[0]["rent"].ToString() == "Null" ? "0.00" : DS.Tables[0].Rows[0]["rent"].ToString() == "" ? "0.00" : DS.Tables[0].Rows[0]["rent"].ToString();
                        txtDeposit.Text= DS.Tables[0].Rows[0]["deposite"].ToString() == "Null" ? "0.00" : DS.Tables[0].Rows[0]["deposite"].ToString() == "" ? "0.00" : DS.Tables[0].Rows[0]["deposite"].ToString();
                        ...
                        txtMaintenance.Text= DS.Tables[0].Rows[0]["maintenance"].ToString() == "Null" ? "0.00" : DS.Tables[0].Rows[0]["maintenance"].ToString() == "" ? "0.00" : DS.Tables[0].Rows[0]["maintenance"].ToString();
        ...
        protected void btnSave_Click(object sender, System.EventArgs e)
        {
            if (Request.QueryString["ID"] != null)
            {
                ...
                {
                    Response.Redirect("ManageRentProperty.aspx?action=update");
                    return;
                }
                else
                {
            ...
            else
            {
                ...
                {
                    ClearForm();
                    Response.Redirect("ManageRentProperty.aspx?action=insert");
                    return;
                }
                else
                {
        ...
        private bool insertProperty()
        {
            ...
            try
            {
                ...
                objBEL.rentOrSale = "Rent";//ddlRentOrSale.SelectedItem.Text.ToString(); 
                ...
                objBEL.rent = Convert.ToDecimal(txtRent.Text);
                objBEL.deposite = Convert.ToDecimal(txtDeposit.Text);
                ...
                objBEL.maintenance = Convert.ToDecimal(txtMaintenance.Text);
                ...
                if (objBALL.addRentProperty(objBEL))
                {
        ...
        private bool updateProperty(int ID)
        {
            ...
            try
            {
                ...
                if (objBALL.updateRentProperty(objBEL))
                {
                    return true;
                }
                else
