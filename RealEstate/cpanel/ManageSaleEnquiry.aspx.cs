...
{
    public partial class ManageSaleEnquiry : System.Web.UI.Page
    {
        ...
        public void fillRepeater()
        {
            ...
            try
            {
                ...
                objDAL.QueryName = "proc_RealEstate_SaleEnquiry_fetchInRepeater";
        ...
        protected void rptrEnquiry_RowCommand(object sender, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AddSaleEnquiry.aspx?ID=" + e.CommandArgument, false);
                return;
            }

            if (e.CommandName == "sold")
            {
                Response.Redirect("SalePropertiesForEnquiry.aspx?ID=" + e.CommandArgument + "&from=enq", false);
                return;
            }
        }
