<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="AddSaleEnquiry.aspx.cs" Inherits="RealEstate.cpanel.AddSaleEnquiry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>     
        function validateForm() {
           ...
           <%-- if (document.getElementById('<%=ddlTenants.ClientID%>').value == "0"  && document.getElementById('<%=ddlPropertyType.ClientID%>').value != "4" && document.getElementById('<%=ddlPropertyType.ClientID%>').value != "5") {
            ...
            if (document.getElementById('<%=txtPriceBudget.ClientID%>').value == "") {
                document.getElementById("lblPriceBudget").style.display = "block";
                document.getElementById('<%=txtPriceBudget.ClientID%>').focus();
                return false;
            }
        }
        ...
        function hidePriceBudgetlbl() {
            document.getElementById("lblPriceBudget").style.display = "none"
        }        
...
<%--                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Price Budget</label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtPriceBudget" runat="server" class="form-control" onclick="hidePriceBudgetlbl()" onkeypress='javascript:return isDecimalNumber(event,this);'></asp:TextBox>
                                    <label id="lblPriceBudget" class="error">Please enter rent amount</label>
                                </div>
                            </div>
