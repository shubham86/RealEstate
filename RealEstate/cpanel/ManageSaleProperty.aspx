<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="ManageSaleProperty.aspx.cs" Inherits="RealEstate.cpanel.ManageSaleProperty" %>
                        ...
                        <asp:Repeater ID="rptrProperty" runat="server" OnItemCommand="rptrProperty_RowCommand">
                                ...
                                <table class="footable table table-stripped" data-page-size="15" data-filter=#filter>
                                    <thead>
                                        <tr>                                            
                                            ...
                                            <th style="text-align:center" data-hide="phone,tablet">Rate</th>
                            ...
                            <ItemTemplate>
                                <tr class="gradeX"> 
                                    ...
                                    <td class="center" style="text-align:center">
                                        <asp:Label ID="lblArea" runat="server" Text='<%#Eval("area").ToString() == "" ? "-" : Eval("area")  + " sq.ft"%>'></asp:Label>
                                    </td>
                                    <td class="center" style="text-align:center">
