...
{
    public partial class RentPropertyDetail : System.Web.UI.Page
    {
        ...
        public void fetchPropertyDetails()
        {
            ...
            try
            {
                ...
                if (DS.Tables[0].Rows.Count > 0)
                {
                    ...
                    lblAge.Text = DS.Tables[0].Rows[0]["age"].ToString() == "" ? "-" : DS.Tables[0].Rows[0]["age"].ToString();
        ...
        {
            Response.Redirect("RentPropertiesForEnquiry.aspx?ID=" + Request.QueryString["EnqID"].ToString(), false);
        }

        protected void btnSoldIt_Onclick(object sender, System.EventArgs e)
        {
            Response.Redirect("AddRentOutEntry.aspx?ID=" + Request.QueryString["ID"].ToString() + "&EnqID=" + Request.QueryString["EnqID"].ToString(), false);
        }
