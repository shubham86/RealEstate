<%@ Page Title="" Language="C#" MasterPageFile="../cpanel/MasterCP.Master" AutoEventWireup="true" CodeBehind="ManageRentEnquiry.aspx.cs" Inherits="RealEstate.cpanel.ManageRentEnquiry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2>Enquiry of rent Property</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="Dashboard.aspx">Home</a>
                </li>
                <li>
                    <a>Enquiry of rent Property</a>
                </li>
                <li class="active">
            ...
            <div class="col-lg-12 main">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Enquiry of rent Property</h5>
                            ...
                            <ItemTemplate>
                                <tr class="gradeX"> 
                                    ...
                                    <td class="center" style="text-align:center;vertical-align:middle">
                                        <asp:Label ID="lblRent" runat="server" Text='<%#Eval("rentBudget")%>'></asp:Label>
                                    </td>
                                    <td class="center" style="text-align:center;vertical-align:middle">
                                        <asp:Label ID="lblTenant" runat="server" Text='<%#Eval("tenants").ToString() == "" ? "-" : Eval("tenants").ToString()%>'></asp:Label>
                                    </td>
                                    <td class="center" style="text-align:center;vertical-align:middle">
                                        ...
                                        <asp:ImageButton ID="imgbtnRentOut" runat="server" ImageUrl="img/search.png" ToolTip="Search Property" Width="18" Height="18"  CommandArgument='<%#Eval("enquiryID")%>' CommandName="search"/>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
