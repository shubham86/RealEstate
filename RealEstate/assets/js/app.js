$(function () {
   ...
   $(".dropdown").on('hover', function () {
    ...
    // Rent Range sliders activation
    $("#divRent").each(function () {
        ...
        $(this).append("" +
            "<span id='spanMinRent' class='min-value'></span> " +
            "<span id='spanMaxRent' class='max-value'></span>" +
            "<input id='MinRent' class='current-min' type='hidden' name='" + minName + "'>" +
            "<input id='MaxRent' class='current-max' type='hidden' name='" + maxName + "'>"
        );
        $(this).slider({
            range: true,
            min: minRangeValue,
            ...
            slide: function (event, ui) {
                ...
                $(this).children("#spanMinRent").text( currentMin + " " + unit);
                $(this).children("#spanMaxRent").text(currentMax + " " + unit);
                $(this).children(".current-min").val(currentMin);
                $(this).children(".current-max").val(currentMax);
                $("#ContentPlaceHolder1_lblMinRent").val(currentMin);
                $("#ContentPlaceHolder1_lblMaxRent").val(currentMax);
            }
        });
    ...
    // Price Range sliders activation
    $("#divPrice").each(function () {
        ...
        $(this).append("" +
            "<span id='spanMinPrice' class='min-value'></span> " +
            "<span id='spanMaxPrice' class='max-value'></span>" +
            "<input id='MinPrice' class='current-min' type='hidden' name='" + minName + "'>" +
            "<input id='MaxPrice' class='current-max' type='hidden' name='" + maxName + "'>"
        );
        $(this).slider({
            range: true,
            min: minRangeValue,
            ...
            slide: function (event, ui) {
                ...
                var currentMin = parseInt(ui.values[0], 10);
                var currentMax = parseInt(ui.values[1], 10);
                $(this).children("#spanMinPrice").text(currentMin + " " + unit);
                $(this).children("#spanMaxPrice").text(currentMax + " " + unit);
                $(this).children(".current-min").val(currentMin);
                $(this).children(".current-max").val(currentMax);
                $("#ContentPlaceHolder1_lblMinPrice").val(currentMin);
                $("#ContentPlaceHolder1_lblMaxPrice").val(currentMax);
            }
        });
